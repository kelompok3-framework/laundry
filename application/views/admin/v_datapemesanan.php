<div class="container-fluid">
	...
	<div align="right">
		<a href="<?php echo base_url('admin/c_pemesanan/hapus_pemesanan') ?>"><div class="btn btn-sm btn-danger">Hapus Semua Pesanan</div></a>
		<a href="<?php echo base_url('admin/c_pemesanan/insert') ?>"><div class="btn btn-sm btn-primary">Lanjutkan Pemesanan</div></a>
		<a href="<?php echo base_url('admin/c_pemesanan/pengisian_data') ?>"><div class="btn btn-sm btn-success">Pengisian Data</div></a>
