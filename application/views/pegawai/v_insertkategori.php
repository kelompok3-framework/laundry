	...
	<body>
		...
		<div class="col-md-8">
		    <div class="card card-warning">
		      ...
		      <form action="<?= base_url()?>pegawai/c_kategori/insert" method="post" enctype="multipart/form-data">
		        <div class="card-body">
		        ...
		        <div class="card-footer alert-success">
		            <div class="modal-footer justify-content-between">
		            	<?php echo anchor('pegawai/c_kategori/', '<div class="btn btn-sm btn-danger">Kembali</div>')?>
