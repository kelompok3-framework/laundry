...
class C_kategori extends CI_Controller{
	...
	public function index()
	{
		...
		$config['base_url']		= 'http://localhost/laundry/pegawai/c_kategori/index';
        ...
        $this->load->view('pegawai/v_kategori', $data);
	...
	public function insert()
	{
		if ($this->input->post()) {
			...
			redirect('pegawai/c_kategori');
		}
		else{
			$data['kategori'] = $this->m_kategori->tampil_data()->result();
			$this->load->view('templates_admin/header');
			$this->load->view('templates_pegawai/sidebar');
			$this->load->view('pegawai/v_insertkategori',$data);
			$this->load->view('templates_admin/footer');
		}
	}
	...
	public function update($id_kategori = null)
	{
		if ($id_kategori != null) {
			...
			$this->load->view('templates_admin/header');
			$this->load->view('templates_pegawai/sidebar');
			$this->load->view('pegawai/v_updatekategori',$data);
			$this->load->view('templates_admin/footer');
		}else{
			if ($this->input->post()) {
